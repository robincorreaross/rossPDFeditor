...
class PageThumbnail(QFrame):
    ...
    def update_thumbnail(self, png_data: bytes):
        """Atualiza a imagem da miniatura a partir de bytes PNG."""
        self._set_thumbnail(png_data)

    def update_thumbnail_pixmap(self, pixmap: QPixmap):
        """Atualiza a imagem da miniatura diretamente com um Pixmap já escalado."""
